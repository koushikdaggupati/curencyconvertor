...
function Login() {
    ...
    function handleLogin(e) {
        e.preventDefault();
        let pass = localStorage.getItem('koushikSubmissionPassword').replace(/"/g, "");
        let mail = localStorage.getItem('koushikSubmissionEmail').replace(/"/g, "");
    ...
    return (
        <div>
            {home ? <form onSubmit={handleLogin}>
                ...
                {flag && <p color='primary' variant="warning" >
